...
<body>
    ...
    <div style="height:10vh; width:98vw;">
        <span class="header"><img src="https://i.imgur.com/I5pJoVM.png" style="max-height: 9vh;"></span>
        <span class="header"><b style="font-size: 30px;">Aqua UMS Project</b></br>Kerjasama Fakulti Komputeran dan
    ...
    <div class="" style="display: none;" id="monitorwindow">
        <div class="grid-container" style=" margin-bottom: 50px;">
            ...
            <div class="grid-item small-widget widget" id="depthtankdiv">Fish Tank Depth<canvas id="chartbar1"
                    style="max-height: 250px;"></canvas></div>
            <div class="grid-item small-widget widget" id="depthfilterdiv">Biofilter Depth<canvas id="chartbar2"
                    style="max-height: 250px;"></canvas></div>
            ...
            <div class="grid-item widget tank-widget" id="infodiv"><u>Tank Info</u></br></br>
                ...
                Location: IPMB
                <span
                    style="position: absolute; top: 40px; right:420px; border: solid; border-width: 1px; border-color: #cccccc; border-radius: 10px; width: 120px;padding: 4px;">
                    Select Tank:
            ...
            <div class="grid-item widget temp-widget " id="tempdiv">Temperature<canvas style="max-height: 175px;"
                    id="chart6"></canvas></div>
        ...
        <div id="modalwindow"
            style="background-color: #000000d7; height: 100vh; width:100vw; position:fixed; top: 0;right: 0; display: none; z-index: 3; ">
        ...
        <div class="loginwindow" style="padding-top:50px;">
            ...
            <div class="form-group">
                <div class="offset-lg-1 col-lg-11">
                    <?= Html::Button('Login', ['class' => 'btn btn-primary', 'name' => 'login-button', 'id' => 'loginsubmit']) ?></br></br>
